...
if (isset($_GET["customerNumber"])) {
    ...
    if ($row) {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $stmt = $conn->prepare($sql);
            $stmt->execute([$customerName, $contactLastName, $contactFirstName, $phone, $addressLine1, $addressLine2, $city, $state, $postalCode, $country, $salesRepEmployeeNumber, $creditLimit, $customerNumber]);
